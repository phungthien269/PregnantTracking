...
// ===========================================================================
// TinhTrangClient — đảo client của /tinh-trang (R8: server shell fetch dữ liệu
// ban đầu, đảo này nhận props + giữ toàn bộ tương tác: khai báo, lịch đo,
// nhật ký chỉ số, biểu đồ, modal).
// ===========================================================================
...
export default function TinhTrangClient({
  ...
  // ---- dữ liệu (khởi tạo từ props server fetch; mutation tự cập nhật state) ----
  ...
  const [measurements, setMeasurements] = useState<MaternalMeasurement[]>(initialMeasurements)
